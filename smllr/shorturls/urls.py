...
urlpatterns = [
    path('<str:short_code>', views.ShortURLRedirectView.as_view(), name='shorturls_redirect'),
    ...
    path('api/analytics/<str:short_code>', api.AnalyticsAPIView.as_view(), name='shorturls_analytics_api'),
]
